...
ActiveRecord::Schema[8.1].define(version: 2026_09_13_100000) do
  ...
  create_table "api_tokens", force: :cascade do |t|
    ...
    t.index ["revoked_at", "expires_at"], name: "index_api_tokens_on_revoked_at_and_expires_at"
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.text "occurrence_dates"
    t.integer "occurrences_per_week", default: 1, null: false
    t.integer "players_count", default: 4
  ...
  create_table "training_blocks", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.json "diagram", default: {}, null: false
    t.integer "duration_minutes"
    ...
    t.integer "user_id", null: false
    t.string "video_url"
    t.index ["shared"], name: "index_training_blocks_on_shared"
