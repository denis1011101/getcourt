module Telegram
  module I18n
    ...
    RU = {
      ...
      invite_message: "Вас приглашают присоединиться:\n%{label}\n\n%{url}",
      prebooking_request_message: "Запрос предбронирования для игры #%{game_id} от %{requester}\nДаты: %{dates}\n\n%{url}",
      approve_all_btn: "Одобрить все",
      reject_all_btn: "Отклонить все",
      prebook_request_not_found: "Запрос не найден",
      prebook_no_permission: "Нет прав",
      prebook_already_processed: "Уже обработано",
      prebook_approved: "Одобрено",
      prebook_rejected: "Отклонено",
      prebook_no_pending: "Нет ожидающих бронирований",
      prebook_all_approved: "Все одобрено",
      prebook_all_rejected: "Все отклонено",
      prebook_user_approved: "Ваше предбронирование игры #%{game_id} на %{date} одобрено.",
      prebook_user_rejected: "Ваше предбронирование игры #%{game_id} на %{date} отклонено.",
      prebook_owner_all_approved_text: "Запрос предбронирования для игры #%{game_id} — все одобрено\nДаты: %{dates}\n\n%{url}",
      prebook_owner_all_rejected_text: "Запрос предбронирования для игры #%{game_id} — все отклонено\nДаты: %{dates}\n\n%{url}",
      prebook_requester_all_approved: "Ваши запросы предбронирования для игры #%{game_id} одобрены.\nДаты: %{dates}\n\n%{url}",
      prebook_requester_all_rejected: "Ваши запросы предбронирования для игры #%{game_id} отклонены.\nДаты: %{dates}\n\n%{url}",
      ...
      create_court_location: "Отправьте локацию корта (кнопка ниже) или введите координаты в формате широта,долгота (например, `56.8431,60.6454`):",
      create_court_location_btn: "Отправить локацию",
      create_court_location_invalid: "Не удалось определить координаты. Отправьте локацию или введите координаты в формате широта,долгота (например, `56.8431,60.6454`).",
      ...
      edit_game_prompt: "Редактирование игры #%{game_id} — выберите поле:",
      edit_field_date: "Дата",
      edit_field_time: "Время",
      edit_field_players: "Количество игроков",
      edit_field_sport: "Вид спорта",
      edit_field_court: "Корт",
      edit_preview_confirm: "Подтвердить",
      edit_choose_new_sport: "Выберите новый вид спорта:",
      edit_choose_players_count: "Выберите количество игроков:",
      edit_send_new_value_for: "Отправьте новое значение для %{label}:",
      edit_back_to_edit: "Назад к редактированию",
      edit_choose_court_page: "Выберите корт — стр. %{page}/%{pages}",
      edit_no_courts_on_page: "На этой странице нет кортов.",
      edit_field_label_date: "дата (ГГГГ-ММ-ДД)",
      edit_field_label_time: "время (ЧЧ:ММ)",
      edit_field_label_players: "кол-во игроков (целое число)",
      edit_field_label_sport: "вид спорта",
      edit_field_label_court: "id корта (целое число)",
      edit_game_not_found: "Игра не найдена.",
    ...
    EN = {
      ...
      invite_message: "You are invited to join:\n%{label}\n\n%{url}",
      prebooking_request_message: "Prebooking request for Game #%{game_id} from %{requester}\nDates: %{dates}\n\n%{url}",
      approve_all_btn: "Approve All",
      reject_all_btn: "Reject All",
      prebook_request_not_found: "Request not found",
      prebook_no_permission: "No permission",
      prebook_already_processed: "Already processed",
      prebook_approved: "Approved",
      prebook_rejected: "Rejected",
      prebook_no_pending: "No pending bookings",
      prebook_all_approved: "All approved",
      prebook_all_rejected: "All rejected",
      prebook_user_approved: "Your prebooking for Game #%{game_id} on %{date} was approved.",
      prebook_user_rejected: "Your prebooking for Game #%{game_id} on %{date} was rejected.",
      prebook_owner_all_approved_text: "Prebooking request for Game #%{game_id} — All approved\nDates: %{dates}\n\n%{url}",
      prebook_owner_all_rejected_text: "Prebooking request for Game #%{game_id} — All rejected\nDates: %{dates}\n\n%{url}",
      prebook_requester_all_approved: "Your prebooking requests for Game #%{game_id} were approved.\nDates: %{dates}\n\n%{url}",
      prebook_requester_all_rejected: "Your prebooking requests for Game #%{game_id} were rejected.\nDates: %{dates}\n\n%{url}",
      ...
      create_court_location: "Send court location (button below) or enter coordinates in lat,lon format (e.g. 56.8431,60.6454):",
      create_court_location_btn: "Send location",
      create_court_location_invalid: "Could not determine coordinates. Send a location or enter coordinates in lat,lon format (e.g. 56.8431,60.6454).",
      ...
      edit_game_prompt: "Edit game #%{game_id} — choose field to edit:",
      edit_field_date: "Date",
      edit_field_time: "Time",
      edit_field_players: "Players",
      edit_field_sport: "Sport / Title",
      edit_field_court: "Court",
      edit_preview_confirm: "Preview / Confirm",
      edit_choose_new_sport: "Choose new sport:",
      edit_choose_players_count: "Choose players count:",
      edit_send_new_value_for: "Send new value for %{label}:",
      edit_back_to_edit: "Back to edit",
      edit_choose_court_page: "Choose court — page %{page}/%{pages}",
      edit_no_courts_on_page: "No courts on this page.",
      edit_field_label_date: "date (YYYY-MM-DD)",
      edit_field_label_time: "time (HH:MM)",
      edit_field_label_players: "players count (integer)",
      edit_field_label_sport: "sport",
      edit_field_label_court: "court id (integer)",
      edit_game_not_found: "Game not found.",
